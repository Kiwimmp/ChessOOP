...
public class Queen extends Piece {
       ...
       /**
        * 
        * Constructs a new Queen object with the given parameters
        * 
        * @param i the ID of the piece
        * @param p the file path of the image representing the piece
        * @param c the color of the piece (0 for white, 1 for black)
        */
       ...
       /**
        * 
        * Returns an ArrayList of all the possible moves of the Queen on the given
        * state and position
        * 
        ...
        * 
        * @return an ArrayList of all the possible moves of the Queen on the given
        *         state and position
        */
